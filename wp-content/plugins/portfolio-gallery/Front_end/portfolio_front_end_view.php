...
function front_end_portfolio($images, $paramssld, $portfolio,$title)
{
...
var defaultBlockWidth=<?php echo $paramssld['ht_view0_block_width']; ?>;
    ...
    var $optionSets = jQuery('#huge_it_portfolio_options_<?php echo $portfolioID; ?> .option-set'),
      ...
      $container.delegate( '.default-block_<?php echo $portfolioID; ?>', 'click', function(){//console.log("delegate");
          var strheight=0;
          jQuery(this).parents('.element_<?php echo $portfolioID; ?>').find('.wd-portfolio-panel_<?php echo $portfolioID; ?> > div').each(function(){//console.log("each");
                strheight+=jQuery(this).outerHeight()+10;
                //alert(strheight);
          })
          strheight+=<?php echo $paramssld['ht_view0_block_height']+45; ?>;
	  			if(jQuery(this).parents('.element_<?php echo $portfolioID; ?>').hasClass("large")){//console.log("hasclass");
    ...
    jQuery('#huge_it_portfolio_content_<?php echo $portfolioID; ?> #shuffle a').click(function(){//console.log("shuffle");
                      ...
                      <div class="element_<?php echo $portfolioID; ?> colorbox_grouping <?php foreach ($catForFilter as $catForFilterValue) { echo str_replace(" ","-",$catForFilterValue)." ";} ?>" data-symbol="<?php echo $row->name; ?>" data-category="alkaline-earth">
                              <div class="default-block_<?php echo $portfolioID; ?>">
                                      <div class="image-block_<?php echo $portfolioID; ?>">
                                              <?php $imgurl=explode(";",$row->image_url); ?>
                                              <?php 	if($row->image_url != ';'){ ?>
                                              <img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo $key; ?>" src="<?php echo $imgurl[0];//get_huge_image($imgurl[0],$image_prefix); ?>" />
                                              <?php } else { ?>
                                              <img alt="<?php echo $row->name; ?>" id="wd-cl-img<?php echo $key; ?>" src="images/noimage.jpg" />
                                              <?php
                                              } ?>	
...
var defaultBlockHeight=<?php echo $paramssld['ht_view2_element_height']; ?>;
  ...
  jQuery(document).ready(function(){
	...
	jQuery('.element_<?php echo $portfolioID; ?> .image-block_<?php echo $portfolioID; ?> .image-overlay a').on('click',function(){//console.log("filter");//
	...
	jQuery('#huge_it_portfolio_popup_list_<?php echo $portfolioID; ?> .popup-wrapper_<?php echo $portfolioID; ?> .right-block ul.thumbs-list_<?php echo $portfolioID; ?> li a').click(function(){//console.log("filter");//thubnail neri meccnelna
		var width=jQuery(window).width();
		if(width<=767){
			jQuery('body').scrollTop(0);
		}
...
.element_<?php echo $portfolioID; ?> {
	...
	//background:#<?php echo $paramssld['ht_view2_element_background_color']; ?>;
	 background-image: url("http://pinkrose.me/wp-content/plugins/post-grid/css/bg/congruent_outline.png");
...
var defaultBlockWidth=<?php echo $paramssld['ht_view4_block_width']; ?>;
  ...
  function changeLayoutMode( $link, options ) {
    ...
    ////filteringgggggg
        ...
        // bind filter on select change
        jQuery(document).ready(function(){
            jQuery('#huge_it_portfolio_filters_<?php echo $portfolioID; ?> ul li').click(function() {//cat selecting
              // get filter value from option value
              var filterValue = jQuery(this).attr('rel');
              // use filterFn if matches value
              filterValue = filterValue;//filterFns[ filterValue ] || 
        ...
        <div id="huge_it_portfolio_container_<?php echo $portfolioID; ?>" class="super-list variable-sizes clearfix" <?php if($paramssld["ht_view6_sorting_float"] == "top" && $paramssld["ht_view6_filtering_float"] == "top") echo "style='clear: both;'";?>>
          ...
          <?php
            ...
            {		
                    ...
                    $catForFilter = explode(",", $row->category);
                    ?>
                    <div class="element_<?php echo $portfolioID; ?> portfolio-lightbox  <?php foreach ($catForFilter as $catForFilterValue) { echo str_replace(" ","-",$catForFilterValue)." ";} ?> " tabindex="0" data-symbol="<?php echo $row->name; ?>" data-category="alkaline-earth">
