					...
					<div style="margin-top: 14px;">
						...
						<div class="">
							...
							<input name="params[ht_view0_sorting_name_by_random]" type="text" id="ht_view0_sorting_name_by_random" value="<?php echo $param_values['ht_view0_sorting_name_by_random']; ?>" size="10" />
                                                ...
                                                <div class="has-background">
							<label for="ht_view0_sorting_name_by_asc">Ascending Sorting Button Name</label>
						...
						<div class="">
							<label for="ht_view0_sorting_name_by_desc">Descending Sorting Button Name</label>
					...
					<div style="margin-top:-80px;">
						...
						<div class="">
							...
							<input name="params[ht_view1_sorting_name_by_random]" type="text" id="ht_view1_sorting_name_by_random" value="<?php echo $param_values['ht_view1_sorting_name_by_random']; ?>" size="10" />
                                                ...
                                                <div class="has-background">
							<label for="ht_view1_sorting_name_by_asc">Ascending Sorting Button Name</label>
						...
						<div class="">
							<label for="ht_view1_sorting_name_by_desc">Descending Sorting Button Name</label>
					...
					<div>					
						...
						<div class="">
							...
							<input name="params[ht_view2_sorting_name_by_random]" type="text" id="ht_view2_sorting_name_by_random" value="<?php echo $param_values['ht_view2_sorting_name_by_random']; ?>" size="10" />
                                                ...
                                                <div class="has-background">
							<label for="ht_view2_sorting_name_by_asc">Ascending Sorting Button Name</label>
						...
						<div class="">
							<label for="ht_view2_sorting_name_by_desc">Descending Sorting Button Name</label>
					...
					<div>
						...
						<div class="">
							...
							<input name="params[ht_view3_sorting_name_by_random]" type="text" id="ht_view3_sorting_name_by_random" value="<?php echo $param_values['ht_view3_sorting_name_by_random']; ?>" size="10" />
                                                ...
                                                <div class="has-background">
							<label for="ht_view3_sorting_name_by_asc">Ascending Sorting Button Name</label>
						...
						<div class="">
							<label for="ht_view3_sorting_name_by_desc">Descending Sorting Button Name</label>
							  ...
							  <option <?php if($param_values['ht_view4_togglebutton_style'] == 'dark'){ echo 'selected="selected"'; } ?> value="dark">Dark</option>
                                        ...
                                        <div style="margin-top: 14px;">
                                            ...
                                            <div style="display: none;">
                                                ...
                                                <div class="has-background">
                                                        <label for="ht_view4_sorting_name_by_asc">Ascending Sorting Button Name</label>
                                                ...
                                                <div class="">
                                                        <label for="ht_view4_sorting_name_by_desc">Descending Sorting Button Name</label>
				...
				<li id="portfolio-view-options-6">
						...
						<div class="">
							...
							<input name="params[ht_view6_sorting_name_by_random]" type="text" id="ht_view6_sorting_name_by_random" value="<?php echo $param_values['ht_view6_sorting_name_by_random']; ?>" size="10" />
                                                ...
                                                <div class="has-background">
							<label for="ht_view6_sorting_name_by_asc">Ascending Sorting Button Name</label>
						...
						<div class="">
							<label for="ht_view6_sorting_name_by_desc">Descending Sorting Button Name</label>
