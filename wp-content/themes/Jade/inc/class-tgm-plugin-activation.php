    ...
    class TGM_Plugin_Activation {
        ...
        public function __construct() {
            ...
            $this->strings = array(
                ...
                'update_link'                   => _n_noop( 'Begin updating plugin', 'Begin updating plugin', 'tgmpa' ),
        ...
        public function notices() {
            ...
            if ( ! empty( $message ) ) {
                ...
                $show_update_link  = $update_link ? '<a href="' . add_query_arg( 'page', $this->menu, network_admin_url( 'themes.php' ) ) . '">' . translate_nooped_plural( $this->strings['update_link'], $update_link_count, 'tgmpa' ) . '</a>' : '';
    ...
    class TGMPA_List_Table extends WP_List_Table {
        ...
        protected function _gather_plugin_data() {
            ...
            foreach ( TGM_Plugin_Activation::$instance->plugins as $plugin ) {
                ...
                if ( ! isset( $installed_plugins[$plugin['file_path']] ) ) {
					...
					$table_data[$i]['status'] = sprintf( '%1$s', __( 'Not Updated', 'tgmpa' ) );
				} else {
					$table_data[$i]['status'] = sprintf( '%1$s', __( 'Active', 'tgmpa' ) );
                }
        ...
        public function process_bulk_actions() {
	        ...
	        if ( 'tgmpa-bulk-install' === $this->current_action()
	             || 'tgmpa-bulk-update' === $this->current_action() ) {
                ...
                foreach ( $plugin_installs as $key => $plugin ) {
	                if ( preg_match( '|.php$|', $plugin && 'tgmpa-bulk-update' !== $this->current_action() ) ) {
