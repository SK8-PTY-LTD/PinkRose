...
add_action('dslc_hook_register_modules',
    create_function('', 'return dslc_register_module( "MET_InfoBox3" );')
);

class MET_InfoBox3 extends DSLC_Module {

    var $module_id = 'MET_InfoBox3';
    var $module_title = 'Vertical with Image 2';
    ...
    function output( $options ) {
        ...
        if( empty($resizedImage['url']) || !in_array( 'image', $elements )){$thumbnail_size = 0;}else{$thumbnail_size = intval($options['thumbnail_size']);}
        $lbExists = !empty($options['lightbox_image']);
        $elID = uniqid('infobox3_');
                ...
                <div class="met_content_box_contents clearfix">
                    ...
                    <div class="met_content_box_contents_text clearfix" style="width: <?php echo 100 - $thumbnail_size;  ?>%;">
                        <?php if( in_array( 'title', $elements ) ) : ?>
                            <h4 class="dslca-editable-content" data-id="title" data-type="simple" style="<?php echo !in_array( 'sub_title', $elements ) ? 'margin-bottom: 15px' : ''; ?>" <?php if ( $dslc_is_admin ) echo 'contenteditable'; ?>><?php echo stripslashes($options['title']); ?></h4>
                        <?php endif; ?>
                        <?php if( in_array( 'sub_title', $elements ) ) : ?>
                            <h5 class="dslca-editable-content met_color" data-id="sub_title" data-type="simple" style="margin-bottom: 15px" <?php if ( $dslc_is_admin ) echo 'contenteditable'; ?>><?php echo stripslashes($options['sub_title']); ?></h5>
                        <?php endif; ?>
