...
add_action('dslc_hook_register_modules',
    create_function('', 'return dslc_register_module( "MET_BrandsCarousel2" );')
);

class MET_BrandsCarousel2 extends DSLC_Module {

    var $module_id = 'MET_BrandsCarousel2';
    var $module_title = 'Carousel with Header';
    ...
    function options() {
        ...
        $dslc_options = array_merge(
            ...
            // Caption
            lc_general('.met_image_carousel_wrap_2_caption', '', array('background-color' => ''), 'Caption'),

            // Caption Paddings
            lc_paddings('.met_image_carousel_wrap_2_caption', '', array('t' => '30', 'r' => '30', 'b' => '30', 'l' => '30')),

            // First Title
            lc_general('.met_image_carousel_wrap_2_caption h4', 'First Title', array('color' => '','font-size' => '24','line-height' => '26', 'font-weight' => '600')),

            // Second Title
            lc_general('.met_image_carousel_wrap_2_caption h5', 'First Title', array('color' => '','font-size' => '16','line-height' => '18', 'font-weight' => '400')),

            // Navigation
            lc_general('.met_image_carousel_wrap_2 nav', 'Navigation', array('background-color' => ''))
        );
    ...
    function output( $options ) {
        ...
        <?php while ( $dslc_query->have_posts() ) : $dslc_query->the_post(); ?>
            <div class="met_image_carousel_wrap_2">
                <div class="met_image_carousel_wrap_2_caption">
