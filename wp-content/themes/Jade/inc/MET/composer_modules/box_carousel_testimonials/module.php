...
add_action('dslc_hook_register_modules',
    create_function('', 'return dslc_register_module( "MET_BoxCarouselTestimonials" );')
);

class MET_BoxCarouselTestimonials extends DSLC_Module {

    var $module_id = 'MET_BoxCarouselTestimonials';
    var $module_title = 'Box Carousel';
    ...
    function options() {
        ...
        $dslc_options = array(
            ...
            array(
                ...
                'id' => 'elements',
                'std' => 'head head_title view_all navigation image title content',
                'type' => 'checkbox',
                'choices' => array(
                    array(
        ...
        $dslc_options = array_merge(
            ...
            // Name
            lc_general('.met_content_box_contents_text h4', 'Name', array('color' => '#393939','font-size' => '36','line-height' => '39','font-weight' => '700')),

            // Work
            lc_general('.met_content_box_contents_text h5', 'Work', array('color' => '','font-size' => '18','line-height' => '22','font-weight' => '700')),
    ...
    function output( $options ) {
        ...
        <div id="<?php echo $elementID ?>" class="met_content_box">
            ...
            <section class="met_content_box_slider" data-speed="500" data-pause="5000">
				<?php
				...
				?>
					<div class="met_content_box_contents clearfix">
						...
						<div class="met_content_box_contents_text clearfix" <?php if(empty( $thumb_url )): ?> style="margin-left: 0;" <?php endif; ?>>
							<h4><?php the_title() ?></h4>
							<h5 class="met_color"><?php echo get_post_meta( get_the_ID(), 'dslc_testimonial_author_pos', true ); ?></h5>
