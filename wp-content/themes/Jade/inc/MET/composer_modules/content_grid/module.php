...
add_action('dslc_hook_register_modules',
    create_function('', 'return dslc_register_module( "MET_ContentGrid" );')
);

class MET_ContentGrid extends DSLC_Module {

	var $module_id = 'MET_ContentGrid';
	var $module_title = 'Showcase Masonry';
